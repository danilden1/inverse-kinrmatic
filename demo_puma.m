...
lb = [deg2rad(-180); deg2rad(-75); deg2rad(-236); deg2rad(-580); deg2rad(-120)];
ub = [deg2rad(110); deg2rad(240); deg2rad(60); deg2rad(40); deg2rad(110)];
...
while 1
    ...
    x = input(in);
    if x == 8 
        theta(1) = theta(1) + 0.05;
    elseif x == 2 
        theta(1) = theta(1) - 0.05;
    elseif x == 6 
        theta(2) = theta(2) + 0.05;
    elseif x == 4 
        theta(2) = theta(2) - 0.05;
    elseif x ==  9
        theta(3) = theta(3) + 0.05;
    elseif x == 7 
        theta(3) = theta(3) - 0.05;
    elseif x == 1 
        theta(4) = theta(4) + 0.05;
    elseif x == 3 
        theta(4) = theta(4) - 0.05;
    elseif x == 5 
        theta(5) = theta(5) + 0.05;
    elseif x == 0 
        theta(5) = theta(5) - 0.05;
    end
